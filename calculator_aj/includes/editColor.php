...
$color = new kalkulatorHcMaterial();
...
if(isset($_POST['submit'])){
    ...
    if(isset($_FILES['fileToUpload']['tmp_name']) && $_FILES['fileToUpload']['tmp_name'] != ""){
        ...
        $color->editColor($edytowaneParamenty,$gdzieParamenty);
        $komunikat = '<p style="color:green;">Zaktualizowano pomyślnie!</p>';
    }else{
      
        $komunikat = "";
    }
    $selectedColor = $color->getColor($id);

    $queryPowrotKolory = array( 'page' => 'calculator_aj_kolor_subcat_menu');

    $remove_args = array( 'page' => 'calculator_aj_kolor_subcat_menu', 'do' => 'remove','id'=>$id ); 
...
?>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="mb-3">
        <?php 
                if(file_exists(KHC_PATH.'uploads/'.$selectedColor->image) && $selectedColor->image != ""):?>
                 <div class="col-md-4">
                     <div class="row mb-3">
                        <img src="<?php echo KHC_PATH.'uploads/'.$selectedColor->image; ?>" class="img-fluid" alt="">
                     </div>
        ...
        <input type="text" class="form-control" name="tytul" id="TytulKolor" aria-describedby="emailHelp" value="<?php echo $selectedColor->tytul;?>" required>
...
<p>Ste si istí, že chcete túto farbu odstrániť?</p>
