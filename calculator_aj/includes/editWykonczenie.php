...
if(isset($_POST['submit'])){
    ...
    if(isset($_FILES['fileToUpload']['tmp_name']) && $_FILES['fileToUpload']['tmp_name'] != ""){
        ...
        $getImage = new kalkulatorHcMaterial();
            $oldImage =$getImage->getWykonczenie($id);
        ...
        $Wykonczenie->editWykonczenie($edytowaneParamenty,$gdzieParamenty);
        $komunikat = '<p style="color:green;">Zaktualizowano pomyślnie!</p>';
    }else{
      
        $komunikat = "";
    }
    $selectedWykonczenie = $Wykonczenie->getWykonczenie($id);

    $queryPowrotWykonczenie = array( 'page' => 'calculator_aj_wykonczenie_subcat_menu');

    $remove_args = array( 'page' => 'calculator_aj_wykonczenie_subcat_menu', 'do' => 'remove','id'=>$id ); 
...
?>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="mb-3">
        <?php 
                if(file_exists(KHC_PATH.'uploads/'.$selectedWykonczenie->image) && $selectedWykonczenie->image != ""):?>
                 <div class="col-md-4">
                     <div class="row mb-3">
                        <img src="<?php echo KHC_PATH.'uploads/'.$selectedWykonczenie->image; ?>" class="img-fluid" alt="">
                     </div>
        ...
        <input type="text" class="form-control" name="tytul" id="TytulKolor" aria-describedby="emailHelp" value="<?php echo $selectedWykonczenie->tytul;?>" required>
        ...
        <input type="text" class="form-control" name="dodatkowytytul" id="dodatkowyTytulKolor" aria-describedby="emailHelp" value="<?php echo $selectedWykonczenie->uniqueText;?>">
    ...
    <a class="khc_powrot" href="<?php echo add_query_arg( $queryPowrotWykonczenie, admin_url( 'admin.php' ) );?>">< späť</a>
